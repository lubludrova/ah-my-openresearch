...
idea is promising, recommend `research-refine` or an experiment draft. If
...
- confidence is `low` and the next recommended step is an experiment draft.
...
### Recommendation
- Next step: <research-refine | draft-exp | idea-creator | wiki-ingest | council-session | ask-librarian | stop>
- Reason: <one sentence>
...
- @prospector — downstream experiment draft planning.

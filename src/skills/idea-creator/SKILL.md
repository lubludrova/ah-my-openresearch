...
- `draft-exp`: accepted and ready for an experiment draft.
...
Decision: <novelty-vs-wiki|research-refine|draft-exp|save-draft|discard>
Overall: <strong|promising|weak|reject>
...
- Follow-on skills:
  - `novelty-vs-wiki`
  - `research-refine`
  - experiment draft planning by @prospector
- Related wiki skills:
  - `wiki-ingest`
  - `wiki-lint`
